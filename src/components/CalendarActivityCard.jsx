...
const iconColors = {
  running: "text-orange-500 bg-orange-50",
  cycling: "text-blue-500 bg-blue-50",
  walking: "text-green-500 bg-green-50",
  tennis: "text-yellow-500 bg-yellow-50",
};
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
                ...
                <div className="text-xs text-gray-500 mb-1 flex items-center gap-2">
                  ...
                  {(() => {
                    ...
                    if (avatarUrl && avatarUrl.trim() !== "") {
                      ...
                      return (
                        <div
                          className="w-5 h-5 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs font-semibold border border-gray-200"
                          style={{ minWidth: 20 }}
                        >
        ...
        <div className="flex flex-col items-center min-w-[80px] rounded-xl  pl-4">
          <button
            ref={popoverRef}
            type="button"
            className="flex flex-col items-center bg-white rounded-xl border border-gray-200 shadow-sm px-3 py-2 transition-all duration-150 hover:shadow-md min-w-[80px] focus:outline-none"
      ...
      {showParticipants && hasParticipants && (
        <div
          className="absolute right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-50 min-w-48 max-w-64"
          ref={dropdownRef}
          onMouseEnter={handlePopoverMouseEnter}
          onMouseLeave={handlePopoverMouseLeave}
        >
      ...
      {isCreator && (
        <div className="mt-3 pt-3 border-t border-gray-100 flex flex-col gap-2">
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-full border border-blue-200 text-blue-500 bg-white hover:bg-blue-50 hover:text-blue-600 transition disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer shadow-sm"
          ...
          {showTransfer &&
            ...
            activity.participants.length > 1 && (
              <div className="mt-2 p-3 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <button
                  className="mt-3 w-full inline-flex justify-center items-center gap-2 px-4 py-2 rounded-xl border border-blue-200 text-blue-600 bg-white hover:bg-blue-50 font-semibold text-sm transition disabled:opacity-60 disabled:cursor-not-allowed"
                  onClick={() =>
                    onCancel &&
